...
public class BoletaModelAssembler implements RepresentationModelAssembler<Boleta, EntityModel<Boleta>>{
    ...
    public EntityModel<Boleta> toModel(Boleta boleta){
        return EntityModel.of(boleta,
                ...
                linkTo(methodOn(BoletaControllerV2.class).putBoleta(Long.valueOf(boleta.getId()),boleta)).withRel("Actualizar boleta"),
                linkTo(methodOn(BoletaControllerV2.class).patchBoleta(Long.valueOf(boleta.getId()),boleta)).withRel("Actualizar boleta parcialmente"),
